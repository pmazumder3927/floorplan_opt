...
WHY THIS RATHER THAN A BUILT-IN. A vertical queen is the only wall bed that fits the wide leg of this plate at all: a HORIZONTAL queen is about 85" wide, and the run between the notch step and the UST plinth is 83", so it does not go in. And the 80 lb mattress ceiling is a real specification, not fine print — it rules out the pocket-sprung VALEVAG this catalog carries for standing beds and points at a 10" foam queen instead.`,
  ...
  {
    id: 'sofa-ceni-61-loveseat-chalk',
    name: 'Article Ceni 61" loveseat, Chalk Gray',
    kind: 'loveseat',
    w: IN(61),
    d: IN(35),
    h: IN(31),
    ...
    color: '#B3ADA4',
    accent: '#BFB9B0',
    source: `Article Ceni 61" Loveseat in Chalk Gray (product 25349): 61" W x 35" D x 31" H, seat height 16", seat depth 23", arm height 24", solid wood legs in a WALNUT stain, 100% polyester at a Martindale rating of 50,000 rubs, 92 lb, loose seat / back / arm cushions. $899. Every figure read directly off article.com on 31 Jul 2026. THE COLOUR IS AN ESTIMATE: Article publishes no LRV and #B3ADA4 / about 44% is read off product photography, which is radiance and not albedo. Order the swatch. WHY IT IS IN THIS CATALOG AS A TESTED-AND-REJECTED ENTRY RATHER THAN A RECOMMENDATION — three numbers, and the money is genuinely on its side at $899 against the Cleon's $1,960. (1) IT IS 31" TALL. The house glazing rule is 30", and this project's own modern/minimal section header lists the heights that pass (KLIPPAN 26", JATTEBO 28", Cleon 28", Gus Mix 28.5", Otio 29", Muuto Fiber 29 3/8", EKENASET 29 7/8") against the ones that fail (SODERHAMN 32 5/8", Floyd 32", LANGARYD 32 1/4", Burrard 33"). At 31" this lands in the second list by an inch. It stands 5 ft off the glass so it clears the analyzer's 1'-0" band, but layout A's own glazing note claims "from every seat in the room the glazing reads full height over the furniture", and at 31" that sentence stops being true. (2) IT IS 61" WIDE WITH ARMS, which is the trade layout A explicitly refuses: 61" of overall width for about 51" of usable seat, against the armless Cleon's 56" for 56". In this plate the sofa's width runs north-south between the bed's foot and the kitchen aisle line, and 7'-8" of that gap minus 5'-1" of sofa leaves a 2'-7" bed aisle where the Cleon leaves 2'-8 3/8" — inside the 2'-6" minimum, but it is spending the tightest dimension in the apartment on arms. (3) SEAT DEPTH 23" AGAINST 26" and a seat 1" lower: a more upright, smaller-feeling seat inside a bigger overall footprint. WHAT IS GOOD ABOUT IT AND SHOULD NOT BE LOST: $1,061 cheaper, LOOSE CUSHIONS — seat, back and arms all lift out, which is not the same thing as zip-off washable covers and Article does not say which it is, so CONFIRM IT; if they do unzip it matters more in a one-room flat with a range twelve feet away than any fabric rating does, and walnut legs that clear the floor's forbidden value band cleanly. If the budget is the binding constraint this is the right answer and the file should say so.`,
    frontClearance: IN(16),
    tags: ['seating', 'loveseat', 'arms', 'walnut', 'mid-century', 'value', 'over-glazing-rule'],
    price: 899,
  },
